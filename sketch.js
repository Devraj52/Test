...
var BGImg,BG2Img,BG3Img,BG4Img;
...
var playImg,play,pauseImg,pause,home,homeImg;

var fire1Img,fire2Img,fire3Img,ManRIMG,CoinsImg,coins,pondImg,pond,embersImg,embers;

var trrorImg,terror,tr,trImg,zmImg,zm,gh1Img,gh2Img,ghost1,ghost2,skullImg,skull,witchImg,witch;
...
function preload(){
  ...
  zgImg=loadAnimation("ZG/ZGL1.png","ZG/ZGL2.png","ZG/ZGL3.png","ZG/ZGL4.png","ZG/ZGL5.png","ZG/ZGL6.png","ZG/ZGL7.png","ZG/ZGL8.png")
  ...
  embersImg=loadImage("embers.png");
...
function setup(){
  ...
  lvl2=createSprite(width/2-150,height/2,1,1);
  lvl2.addImage(lvl2Img);
  lvl2.scale=0.4;
  lvl2.visible=false;

  lvl3=createSprite(width/2-150,height/2,1,1);
  lvl3.addImage(lvl3Img);
  lvl3.scale=0.4;
  lvl3.visible=false;
...
function draw(){
  ...
  if(mousePressedOver(home)){
    ...
    if(fireGroup.isTouching(Man)||terrorGroup.isTouching(Man)||zmGroup.isTouching(Man)||witchGroup.isTouching(Man)||skullGroup.isTouching(Man)||ghost1Group.isTouching(Man)||ghost2Group.isTouching(Man)||bmb1Group.isTouching(Man)||bmb2Group.isTouching(Man)||rck1Group.isTouching(Man)||rck2Group.isTouching(Man)||trGroup.isTouching(Man)){
    gameState = END;
    }
}
    ...
    back.velocityX=0
    start.visible=false;
    Man.changeAnimation("Man stop",manStop);
  ...
  if(gameState==="serve"){
   ...
   textSize(20);
    ...
    text("Press spacebar key to shoot the animals.",width/2-150,height/2+90);
...
function spawnCoins() {
  var coins = createSprite(width-10,Math.round(random(40,400)), 10, 10);
  coins.debug=false;
...
function Bg2(){
  ...
  var selectzombies = Math.round(random(1,1));
  if (World.frameCount % 80 == 0) {
  if(selectzombies == 1){
    spawnZM();
  }
